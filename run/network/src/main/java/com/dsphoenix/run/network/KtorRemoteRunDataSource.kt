...
import com.dsphoenix.core.data.networking.constructRoute
import com.dsphoenix.core.data.networking.delete
import com.dsphoenix.core.data.networking.get
import com.dsphoenix.core.data.networking.safeCall
...
import com.dsphoenix.core.domain.util.map
            ...
            httpClient.submitFormWithBinaryData(
                ...
                formData = formData {
                    append("MAP_PICTURE", mapPicture, Headers.build {
                        ...
                        append(HttpHeaders.ContentDisposition, "filename=mappic.jpg")
                    })
