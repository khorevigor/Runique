package com.dsphoenix.wear.run.presentation.ambient
...
private fun Modifier.ambientGray(isAmbientMode: Boolean): Modifier {
...
private fun rememberBurnInTranslation(
    ...
    LaunchedEffect(key1 = isAmbientMode, burnInProtectionRequired) {
